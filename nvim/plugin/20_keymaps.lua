...
vim.keymap.set("n", "<leader>lgh", vim.cmd.LspClangdSwitchSourceHeader, { desc = 'Clangd Switch Header/Source' })
vim.keymap.set('t', "<Esc>", '<C-\\><C-n>', { desc = 'Use esc to get out of terminal mode' })
